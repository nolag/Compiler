...
public class JoosASTBuilder implements IASTBuilder{
    ...
    private static final Iterable<ASTSymbolFactory> simplifications = Arrays.asList(new ASTSymbolFactory [] {
            new ListedSymbolFactory(), new TypeSymbolFactory(), new QualifiedIdSymbolFactory(), new PackageImportFactory(), new ClassInterfaceFactory(), new IntegerLiteralFactory(), new StringLiteralFactory(), oneChild});
