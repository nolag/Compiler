...
public class Smlal extends ArmInstruction {
    ...
    public Smlal(Condition c, final Register destHi, final Register destLo, final Register lhs, final Register rhs) {
        super(3);
        this.c = c;
        this.destHi = destHi;
        this.destLo = destLo;
    ...
    public Smlal(final Register destHi, final Register destLo, final Register lhs, final Register rhs) {
