...
public class Movw extends MovBase {
    public Movw(final Condition cond, final Register dest, final Operand2 src, final SizeHelper<ArmInstruction, Size> sizeHelper) {
        super("movw", cond, dest, src, sizeHelper);
    }

    public Movw(final Condition cond, final Register dest, final Immediate16 imm, final SizeHelper<ArmInstruction, Size> sizeHelper) {
        super("movw", cond, dest, imm, sizeHelper);
    }

    public Movw(final Condition cond, final Register dest, final ImmediateStr imm, final SizeHelper<ArmInstruction, Size> sizeHelper) {
        super("movw", cond, dest, imm, sizeHelper);
    }
