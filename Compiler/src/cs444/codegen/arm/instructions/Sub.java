...
public class Sub extends DataProcessingWithDestination {
    public Sub(final boolean s, final Conditional when, final Register dest, final Register rhs, 
    ...
    public Sub(final Conditional when, final Register dest, final Register rhs, 
            final Operand2 lhs, final SizeHelper<ArmInstruction, Size> sizeHelper) {
