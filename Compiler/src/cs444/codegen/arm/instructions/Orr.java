...
public class Orr extends DataProcessingWithDestination {
    public Orr(final boolean s, final Conditional when, final Register dest, final Register rhs, 
    ...
    public Orr(final Conditional when, final Register dest, final Register rhs, 
            final Operand2 lhs, final SizeHelper<ArmInstruction, Size> sizeHelper) {
