...
public class LongJxxTile<T extends BinOpExpr> implements ITile<X86Instruction, Size, T> {
    ...
    public static <T extends BinOpExpr> LongJxxTile<T> getTile(final JxxMaker finishEarlyT, final JxxMaker finishEarlyF,
            final JxxMaker finishRegular, Class<T> klass) {
    ...
    private LongJxxTile(final JxxMaker finishEarlyT, final JxxMaker finishEarlyF, final JxxMaker finishRegular) {
