...
public class Shl extends BinInstruction {
    ...
    public Shl(final Register reg, final Immediate arg, final Size size, final SizeHelper<X86Instruction, Size> sizeHelper) {
        super("shl", reg, arg, sizeHelper, size, Size.LOW, 2);
    }
    ...
    public Shl(final Register reg, final InstructionArg arg, final Size size, final SizeHelper<X86Instruction, Size> sizeHelper) {
        super("shl", reg, arg, sizeHelper, size, Size.LOW, 3);
    }
    ...
    public Shl(final Memory reg, final InstructionArg arg, final Size size, final SizeHelper<X86Instruction, Size> sizeHelper) {
        super("shl", reg, arg, sizeHelper, size, Size.LOW, 4);
    }
}
