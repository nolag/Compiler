...
public class Add extends BinInstruction{
    ...
    public Add(final Register addTo, final Memory addWith, final Size size, final SizeHelper<X86Instruction, Size> sizeHelper) {
        super("add", addTo, addWith, sizeHelper, size, 2);
    }
    ...
    public Add(final Register addTo, final InstructionArg addWith, final Size size, final SizeHelper<X86Instruction, Size> sizeHelper) {
        super("add", addTo, addWith, sizeHelper, size, 1);
    }
    ...
    public Add(final Memory addTo, final NotMemory addWith, final Size size, final SizeHelper<X86Instruction, Size> sizeHelper) {
        super("add", addTo, addWith, sizeHelper, size, 3);
    }
}
