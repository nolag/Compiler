...
public class AssignmentTile implements ITile<X86Instruction, Size, AssignmentExprSymbol> {
    ...
    @Override
    public boolean fits(final AssignmentExprSymbol symbol, final Platform<X86Instruction, Size> platform) {
        return true;
    }
