...
public class LongMultTile extends LongOnlyTile<ArmInstruction, Size, MultiplyExprSymbol> {
    ...
    @Override
    public InstructionsAndTiming<ArmInstruction> generate(MultiplyExprSymbol mul,
        ...
        Typeable lhs = (Typeable) mul.children.get(0);
        ...
        Typeable rhs = (Typeable) mul.children.get(1);
