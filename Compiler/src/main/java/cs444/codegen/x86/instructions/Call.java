...
public class Call extends UniInstruction {
    ...
    public Call(Immediate what, SizeHelper<X86Instruction, Size> sizeHelper) {
        super("call", what, sizeHelper, 3, 1);
    }

    public Call(InstructionArg<X86Instruction, Size> what, SizeHelper<X86Instruction, Size> sizeHelper) {
