...
public class IMul extends X86Instruction {
    ...
    public IMul(final InstructionArg<X86Instruction, Size> arg1, final SizeHelper<X86Instruction, Size> sizeHelper) {
        this(arg1, sizeHelper.getDefaultSize(), sizeHelper);
    }

    public IMul(final InstructionArg<X86Instruction, Size> arg1, final Size size, final SizeHelper<X86Instruction, Size> sizeHelper) {
    ...
    public IMul(final Register arg1, final InstructionArg<X86Instruction, Size> arg2, final SizeHelper<X86Instruction, Size> sizeHelper) {
        this(arg1, arg2, sizeHelper.getDefaultSize(), sizeHelper);
    }

    public IMul(final Register arg1, final InstructionArg<X86Instruction, Size> arg2, final Size size, final SizeHelper<X86Instruction, Size> sizeHelper) {
        super(42, 6);
        this.arg1 = arg1;
        this.arg2 = arg2;
        this.sizeHelper = sizeHelper;
