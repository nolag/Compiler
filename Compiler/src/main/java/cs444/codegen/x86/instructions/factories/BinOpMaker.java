...
public interface BinOpMaker {
    ...
    public X86Instruction make(Register one, Immediate two, SizeHelper<X86Instruction, Size> sizeHelper);
    public X86Instruction make(Register one, Immediate two, Size size, SizeHelper<X86Instruction, Size> sizeHelper);
}
